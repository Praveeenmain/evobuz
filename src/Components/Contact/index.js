...
const Contact = () => {
  ...
  return (
    <div className="vendor-contact-form">
      <h1>Contact</h1>
      <form ref={form} onSubmit={sendEmail} className="vendor-contact-form-container">
        ...
        <div className="vendor-contact-form-group">
          <button type="submit" className="vendor-contact-btn vendor-contact-btn-primary" disabled={loading}>
